      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 mt-6 max-w-2xl mx-auto">
            Ready to bring your geospatial vision to life? Let's discuss your next project and create something amazing together.
          </p>
        </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-8">
                ...
                or simply chat about the latest developments in GIS technology and mobile development. 
